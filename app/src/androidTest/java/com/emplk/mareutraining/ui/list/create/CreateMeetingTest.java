...
public class CreateMeetingTest {
    ...
    @Test
    public void onAddOnlyDateField_shouldPreventAddingUncompletedMeeting() {
        ...
        onView(withText(R.string.check_submit_btn_toast)).inRoot(isToast()).check(matches(isDisplayed()));
        onView(withId(R.id.activity_create_meeting)).check(matches(isDisplayed()));
    }

    @Test
    public void onFillEveryField_clickCreateBtn_shouldAddNewMeeting() {
    ...
    @Test
    public void onFillEveryField_whenFilled_shouldDisplayChosenInfo() {
        onView(withId(R.id.add_fab)).perform(click());
    ...
    @Test
    public void onMeetingStartAt2_meetingEndAt1_shouldDisplayToastError() {
        onView(withId(R.id.add_fab)).perform(click());
